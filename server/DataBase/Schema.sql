...
USE ampeca
CREATE TABLE user (id int AUTO_INCREMENT ,username varchar (200), email varchar(200) , password varchar(225),last_login DATE,UNIQUE KEY email (email), PRIMARY KEY (id)) ; 
