...
USE ampeca
CREATE TABLE user (id int AUTO_INCREMENT ,username varchar (50), email varchar(50) , password varchar(225),last_login DATETIME,UNIQUE KEY email (email), PRIMARY KEY (id)) ; 
